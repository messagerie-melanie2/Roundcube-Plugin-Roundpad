...
class roundpad_files_engine
{
    ...
    public function ui()
    {
        ...
        $this->plugin->add_label('etherpad', 'ethercalc', 'other', 'me', 'message_subject', 'message_body');
    ...
    public function file_create_form($attrib)
    {
      ...
      $this->plugin->add_label('filecreating', 'filecreatenotice', 'create', 'filecreate', 'cancel', 'open');
...
*/
    ...
    protected function action_folder_list() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantlistfolders');
      }
    ...
    protected function action_file_list() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantlistfiles');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_file_create() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantcreatefile');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_file_delete() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantdeletefiles');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_file_move() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantmovefiles');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_file_edit() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('canteditfile');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_folder_create() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantcreatefolder');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_folder_delete() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantdeletefolder');
      }
      echo json_encode($result);
      exit;
    }
    ...
    protected function action_folder_move() {
      ...
      try {
        ...
        $result['status'] = 'NOK';
        $result['reason'] = $this->plugin->gettext('cantmovefolder');
      }
      echo json_encode($result);
      exit;
    }
