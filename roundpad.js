...
*/
      ...
      rcmail.enable_command('menu-open', 'menu-save', 'files-sort', 'files-search', 'files-search-reset', 'folder-create', 'file-create', true);
  ...
  this.file_list_row = function(file, data, index)
  {
    ...
    for (c in rcmail.env.coltypes) {
      ...
      if (c == 'name')
        ...
        col = '<td class="url"><a target="_blank" href="' + data.url + '">' + data.url + '</td>';
      else if (c == 'owner')
